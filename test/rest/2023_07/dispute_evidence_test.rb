...
class DisputeEvidence202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/shopify_payments/disputes/598735659/dispute_evidences.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/shopify_payments/disputes/598735659/dispute_evidences.json")
  ...
  def test_2()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/shopify_payments/disputes/598735659/dispute_evidences.json")
      .with(
    ...
    response = dispute_evidence = ShopifyAPI::DisputeEvidence.new(session: @shopify_api_config.active_session)
    dispute_evidence.dispute_id = 598735659
    dispute_evidence.submit_evidence = true
    dispute_evidence.save

    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/shopify_payments/disputes/598735659/dispute_evidences.json")
