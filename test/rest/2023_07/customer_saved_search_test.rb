...
class CustomerSavedSearch202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches.json?since_id=20610973")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches.json?since_id=20610973")
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches.json")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/count.json")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/count.json?since_id=20610973")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/count.json?since_id=20610973")
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109.json")
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109.json")
  ...
  def test_9()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109.json")
  ...
  def test_10()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109/customers.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/customer_saved_searches/789629109/customers.json")
