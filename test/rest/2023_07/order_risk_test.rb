...
class OrderRisk202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks/284138680.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks/284138680.json")
  ...
  def test_4()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks/284138680.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks/284138680.json")
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks/284138680.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/orders/450789469/risks/284138680.json")
