...
class Checkout202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts.json")
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts.json")
      ...
      .to_return(status: 200, body: JSON.generate({"checkout" => {"completed_at" => nil, "created_at" => "2023-07-11T18:33:47-04:00", "currency" => "USD", "presentment_currency" => "USD", "customer_id" => 1073339481, "customer_locale" => "en", "device_id" => nil, "discount_code" => nil, "discount_codes" => [], "email" => "me@example.com", "legal_notice_url" => nil, "location_id" => nil, "name" => "#1066348319", "note" => "", "note_attributes" => {}, "order_id" => nil, "order_status_url" => nil, "order" => nil, "payment_due" => "0.00", "payment_url" => "https://app.local/cardserver/sessions", "payments" => [], "phone" => nil, "shopify_payments_account_id" => nil, "privacy_policy_url" => nil, "refund_policy_url" => nil, "requires_shipping" => false, "reservation_time_left" => 0, "reservation_time" => nil, "source_identifier" => nil, "source_name" => "755357713", "source_url" => nil, "subscription_policy_url" => nil, "subtotal_price" => "0.00", "shipping_policy_url" => nil, "tax_exempt" => false, "taxes_included" => false, "terms_of_sale_url" => nil, "terms_of_service_url" => nil, "token" => "e4460cb95d490ecb205940c3a088ecf8", "total_price" => "0.00", "total_tax" => "0.00", "total_tip_received" => "0.00", "total_line_items_price" => "0.00", "updated_at" => "2023-07-11T18:33:47-04:00", "user_id" => nil, "web_url" => "https://jsmith.myshopify.com/548380009/checkouts/e4460cb95d490ecb205940c3a088ecf8", "total_duties" => nil, "total_additional_fees" => nil, "line_items" => [], "gift_cards" => [], "tax_lines" => [], "tax_manipulations" => [], "shipping_line" => nil, "shipping_rate" => nil, "shipping_address" => nil, "credit_card" => nil, "billing_address" => nil, "applied_discount" => nil, "applied_discounts" => [], "discount_violations" => []}}), headers: {})
  ...
  def test_4()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/bd5a8aa1ecd019dd3520ff791ee3a24c.json")
  ...
  def test_5()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/7yjf4v2we7gamku6a6h7tvm8h3mmvs4x.json")
  ...
  def test_6()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a.json")
  ...
  def test_7()
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a.json")
  ...
  def test_9()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a/shipping_rates.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/exuw7apwoycchjuwtiqg8nytfhphr62a/shipping_rates.json")
  ...
  def test_11()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/zs9ru89kuqcdagk8bz4r9hnxt22wwd42/shipping_rates.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/checkouts/zs9ru89kuqcdagk8bz4r9hnxt22wwd42/shipping_rates.json")
