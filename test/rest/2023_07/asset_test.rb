...
class Asset202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json")
  ...
  def test_2()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json")
      .with(
      ...
      .to_return(status: 200, body: JSON.generate({"asset" => {"key" => "templates/index.liquid", "public_url" => nil, "created_at" => "2010-07-12T15:31:50-04:00", "updated_at" => "2023-07-11T18:05:00-04:00", "content_type" => "application/x-liquid", "size" => 110, "checksum" => "cd71db2e14df976c8aa44b44c8dae77b", "theme_id" => 828155753}}), headers: {})

    response = asset = ShopifyAPI::Asset.new(session: @shopify_api_config.active_session)
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json")
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json")
      ...
      .to_return(status: 200, body: JSON.generate({"asset" => {"key" => "layout/alternate.liquid", "public_url" => nil, "created_at" => "2023-07-11T18:05:03-04:00", "updated_at" => "2023-07-11T18:05:03-04:00", "content_type" => "application/x-liquid", "size" => 3049, "checksum" => "1879a06996941b2ff1ff485a1fe60a97", "theme_id" => 828155753}}), headers: {})
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
