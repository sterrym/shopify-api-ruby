...
class LocationsForMove202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/fulfillment_orders/1046000834/locations_for_move.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/fulfillment_orders/1046000834/locations_for_move.json")
