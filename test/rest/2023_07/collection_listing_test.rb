...
class CollectionListing202307Test < Test::Unit::TestCase
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/collection_listings/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/collection_listings/482865238.json")
