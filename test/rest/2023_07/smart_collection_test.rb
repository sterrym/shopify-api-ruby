...
class SmartCollection202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json?since_id=482865238")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"smart_collections" => [{"id" => 1063001337, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2023-07-11T18:36:49-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:36:49-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "title", "relation" => "starts_with", "condition" => "iPod"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001337"}]}), headers: {})
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json?since_id=482865238")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"smart_collections" => [{"id" => 482865238, "handle" => "smart-ipods", "title" => "Smart iPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2023-07-11T18:32:46-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689114766"}}]}), headers: {})

    response = ShopifyAPI::SmartCollection.all(
      session: @shopify_api_config.active_session,
    )

    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json?product_id=632910392")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json?ids=482865238%2C1063001341")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"smart_collections" => [{"id" => 1063001341, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:37:19-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:37:19-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "vendor", "relation" => "equals", "condition" => "Apple"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001341"}, {"id" => 482865238, "handle" => "smart-ipods", "title" => "Smart iPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2023-07-11T18:32:46-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689114766"}}]}), headers: {})
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json?ids=482865238%2C1063001341")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/count.json")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/count.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/count.json?product_id=632910392")
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "smart_collection" => hash_including({"published" => false}) }
      )
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"title" => "Smart iPods", "handle" => "smart-ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 482865238, "published_at" => nil, "updated_at" => "2023-07-11T18:37:21-04:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2023-07-11T18:32:46-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689114766"}}}), headers: {})

    response = smart_collection = ShopifyAPI::SmartCollection.new(session: @shopify_api_config.active_session)
    smart_collection.id = 482865238
    smart_collection.published = false
    smart_collection.save

    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"title" => "Smart iPods", "handle" => "smart-ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 482865238, "published_at" => "2023-07-11T18:36:58-04:00", "updated_at" => "2023-07-11T18:36:58-04:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2023-07-11T18:32:46-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689114766"}}}), headers: {})
  ...
  def test_10()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "smart_collection" => hash_including({"image" => "", "updated_at" => "2023-07-11T18:36:54-04:00", "title" => "Smart iPods", "handle" => "smart-ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238"}) }
      )
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"body_html" => "<p>The best selling ipod ever</p>", "handle" => "smart-ipods", "updated_at" => "2023-07-11T18:36:55-04:00", "id" => 482865238, "sort_order" => "manual", "title" => "Smart iPods", "disjunctive" => false, "template_suffix" => nil, "published_at" => "2008-02-01T19:00:00-05:00", "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238"}}), headers: {})
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"body_html" => "<p>5000 songs in your pocket</p>", "title" => "Smart iPods", "handle" => "smart-ipods", "id" => 482865238, "updated_at" => "2023-07-11T18:36:46-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "type", "relation" => "equals", "condition" => "Cult Products"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/482865238", "image" => {"created_at" => "2023-07-11T18:32:46-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689114766"}}}), headers: {})
  ...
  def test_14()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238.json")
  ...
  def test_15()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
  ...
  def test_17()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"id" => 1063001330, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:36:34-04:00", "body_html" => nil, "published_at" => nil, "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "vendor", "relation" => "equals", "condition" => "Apple"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001330"}}), headers: {})
  ...
  def test_18()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"id" => 1063001329, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2023-07-11T18:36:31-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:36:31-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "title", "relation" => "starts_with", "condition" => "iPod"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001329"}}), headers: {})
  ...
  def test_19()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"smart_collection" => {"id" => 1063001336, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:36:45-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:36:45-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "disjunctive" => false, "rules" => [{"column" => "vendor", "relation" => "equals", "condition" => "Apple"}], "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001336"}}), headers: {})
  ...
  def test_20()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238/order.json?products%5B%5D=921728736&products%5B%5D=632910392")
  ...
  def test_21()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238/order.json?sort_order=alpha-desc")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/smart_collections/482865238/order.json?sort_order=alpha-desc")
