...
class Province202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces.json?since_id=536137098")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces.json?since_id=536137098")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces/count.json")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces/224293623.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces/224293623.json")
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces/224293623.json")
      .with(
    ...
    response = province = ShopifyAPI::Province.new(session: @shopify_api_config.active_session)
    province.country_id = 879921427
    province.id = 224293623
    province.tax = 0.09
    province.save

    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427/provinces/224293623.json")
