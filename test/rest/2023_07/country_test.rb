...
class Country202307Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries.json?since_id=359115488")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries.json?since_id=359115488")
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-07/countries.json")
      .with(
    ...
    response = country = ShopifyAPI::Country.new(session: @shopify_api_config.active_session)
    country.code = "FR"
    country.save

    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-07/countries.json")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/count.json")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427.json")
  ...
  def test_7()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427.json")
  ...
  def test_8()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-07/countries/879921427.json")
