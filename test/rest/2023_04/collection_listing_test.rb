...
class CollectionListing202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/841564295/product_ids.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/841564295/product_ids.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/482865238.json")
  ...
  def test_4()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/482865238.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/482865238.json")
  ...
  def test_5()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/482865238.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/collection_listings/482865238.json")
