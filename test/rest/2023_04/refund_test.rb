...
class Refund202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/orders/450789469/refunds.json")
      .with(
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/orders/450789469/refunds.json")
      .with(
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/orders/450789469/refunds/509562969.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/orders/450789469/refunds/calculate.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
