...
class Report202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports.json?since_id=123")
      .with(
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports.json?fields=id%2Cshopify_ql")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports.json?ids=517154478")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports.json?updated_at_min=2005-07-31+15%3A57%3A11+EDT+-04%3A00")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports/517154478.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/reports/517154478.json?fields=id%2Cshopify_ql")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/reports/517154478.json")
      .with(
  ...
  def test_9()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/reports/517154478.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_10()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/reports.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
