...
class Article202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json?since_id=134645308")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json?since_id=134645308")
  ...
  def test_3()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
      .with(
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"id" => 1051293790, "title" => "My new Article title", "created_at" => "2023-07-11T18:13:09-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-07-11T18:13:09-04:00", "summary_html" => nil, "template_suffix" => nil, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293790"}}), headers: {})

    response = article = ShopifyAPI::Article.new(session: @shopify_api_config.active_session)
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
  ...
  def test_4()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"id" => 1051293783, "title" => "My new Article title", "created_at" => "2023-07-11T18:12:20-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-07-11T18:12:20-04:00", "summary_html" => nil, "template_suffix" => nil, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293783", "image" => {"created_at" => "2023-07-11T18:12:20-04:00", "alt" => nil, "width" => 1, "height" => 1, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/df3e567d6f16d040326c7a0ea29a4f41.gif?v=1689113540"}}}), headers: {})
  ...
  def test_5()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"id" => 1051293782, "title" => "My new Article title", "created_at" => "2023-07-11T18:12:17-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-07-11T18:12:17-04:00", "summary_html" => nil, "template_suffix" => nil, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293782"}}), headers: {})
  ...
  def test_6()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"id" => 1051293786, "title" => "My new Article title", "created_at" => "2023-07-11T18:12:40-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => "2011-03-24T11:45:47-04:00", "updated_at" => "2023-07-11T18:12:40-04:00", "summary_html" => nil, "template_suffix" => nil, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293786", "image" => {"created_at" => "2023-07-11T18:12:40-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/rails_logo20230711-85514-jc6ecc.gif?v=1689113560"}}}), headers: {})
  ...
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"id" => 1051293785, "title" => "My new Article title", "created_at" => "2023-07-11T18:12:37-04:00", "body_html" => "<h1>I like articles</h1>\n<p><strong>Yea</strong>, I like posting them through <span class=\"caps\">REST</span>.</p>", "blog_id" => 241253187, "author" => "John Smith", "user_id" => 548380009, "published_at" => nil, "updated_at" => "2023-07-11T18:12:37-04:00", "summary_html" => nil, "template_suffix" => nil, "handle" => "my-new-article-title", "tags" => "Has Been Tagged, This Post", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/1051293785"}}), headers: {})
  ...
  def test_8()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/count.json")
  ...
  def test_9()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
  ...
  def test_10()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "article" => hash_including({"metafields" => [{"key" => "new", "value" => "newvalue", "type" => "single_line_text_field", "namespace" => "global"}]}) }
      )
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "title" => "get on the train now", "handle" => "get-on-the-train-now", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => 548380009, "published_at" => "2008-07-31T20:00:00-04:00", "updated_at" => "2023-07-11T18:12:47-04:00", "summary_html" => nil, "template_suffix" => nil, "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1689112056"}}}), headers: {})
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
  ...
  def test_11()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "published_at" => nil, "title" => "get on the train now", "handle" => "get-on-the-train-now", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => 548380009, "updated_at" => "2023-07-11T18:12:31-04:00", "summary_html" => nil, "template_suffix" => nil, "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_12()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "published_at" => "2023-07-11T18:13:03-04:00", "title" => "get on the train now", "handle" => "get-on-the-train-now", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => 548380009, "updated_at" => "2023-07-11T18:13:03-04:00", "summary_html" => nil, "template_suffix" => nil, "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "updated_at" => "2023-07-11T18:13:24-04:00", "id" => 134645308, "title" => "get on the train now", "created_at" => "2008-07-31T20:00:00-04:00", "body_html" => "<p>Do <em>you</em> have an <strong>IPod</strong> yet?</p>", "author" => "Dennis", "user_id" => 548380009, "published_at" => "2008-07-31T20:00:00-04:00", "summary_html" => nil, "template_suffix" => nil, "handle" => "get-on-the-train-now", "tags" => "Announcing", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308"}}), headers: {})
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "author" => "Your name", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "2011-03-24T11:45:47-04:00", "title" => "My new Title", "updated_at" => "2023-07-11T18:12:35-04:00", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => nil, "summary_html" => nil, "template_suffix" => nil, "handle" => "get-on-the-train-now", "tags" => "Tags, Updated, Will Be", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => {"created_at" => "2023-07-11T18:12:35-04:00", "alt" => nil, "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1689113555"}}}), headers: {})
  ...
  def test_15()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "author" => "Your name", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "2011-03-24T11:45:47-04:00", "title" => "My new Title", "handle" => "get-on-the-train-now", "user_id" => nil, "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "updated_at" => "2023-07-11T18:12:55-04:00", "summary_html" => nil, "template_suffix" => nil, "tags" => "Tags, Updated, Will Be", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "iMac", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/imac.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_16()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      ...
      .to_return(status: 200, body: JSON.generate({"article" => {"blog_id" => 241253187, "author" => "Your name", "body_html" => "<p>Look, I can even update through a web service.</p>", "published_at" => "2011-03-24T11:45:47-04:00", "title" => "My new Title", "handle" => "get-on-the-train-now", "id" => 134645308, "created_at" => "2008-07-31T20:00:00-04:00", "user_id" => nil, "updated_at" => "2023-07-11T18:12:23-04:00", "summary_html" => nil, "template_suffix" => nil, "tags" => "Tags, Updated, Will Be", "admin_graphql_api_id" => "gid://shopify/OnlineStoreArticle/134645308", "image" => {"created_at" => "2023-07-11T18:12:23-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/articles/rails_logo20230711-85514-76fa34.gif?v=1689113543"}}}), headers: {})
  ...
  def test_17()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/134645308.json")
  ...
  def test_18()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/articles/authors.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/articles/authors.json")
  ...
  def test_19()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/articles/tags.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/articles/tags.json")
  ...
  def test_20()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/articles/tags.json?limit=1&popular=1")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/articles/tags.json?limit=1&popular=1")
  ...
  def test_21()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/tags.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/tags.json")
  ...
  def test_22()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/tags.json?limit=1&popular=1")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/blogs/241253187/articles/tags.json?limit=1&popular=1")
