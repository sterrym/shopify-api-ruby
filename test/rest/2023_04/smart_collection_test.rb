...
class SmartCollection202304Test < Test::Unit::TestCase
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/smart_collections.json?ids=482865238%2C1063001341")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/smart_collections.json?ids=482865238%2C1063001341")
