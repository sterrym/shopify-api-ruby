...
class Asset202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json")
  ...
  def test_2()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json?asset%5Bkey%5D=templates%2Findex.liquid")
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/themes/828155753/assets.json?asset%5Bkey%5D=assets%2Fbg-body.gif")
