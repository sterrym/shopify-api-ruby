...
class TenderTransaction202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?since_id=1011222855")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?since_id=1011222855")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?order=processed_at+ASC")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?order=processed_at+ASC")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?processed_at_min=2005-08-06+10%3A22%3A51+-0400")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?processed_at_min=2005-08-06+10%3A22%3A51+-0400")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?processed_at_max=2005-08-06+10%3A22%3A51+-0400")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?processed_at_max=2005-08-06+10%3A22%3A51+-0400")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?processed_at_max=2005-08-05+10%3A22%3A51+-0400")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/tender_transactions.json?processed_at_max=2005-08-05+10%3A22%3A51+-0400")
