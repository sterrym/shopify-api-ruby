...
class ApplePayCertificate202304Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates.json")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938276.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938276.json")
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938277.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938277.json")
  ...
  def test_4()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938274.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938274.json")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938278/csr.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-04/apple_pay_certificates/1068938278/csr.json")
