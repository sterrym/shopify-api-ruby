...
class TenderTransaction202207Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-07/tender_transactions.json?since_id=1011222855")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-07/tender_transactions.json?since_id=1011222855")
