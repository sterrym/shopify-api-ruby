...
class ApplePayCertificate202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/apple_pay_certificates.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-01/apple_pay_certificates.json")
  ...
  def test_3()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/apple_pay_certificates/1068938277.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-01/apple_pay_certificates/1068938277.json")
