...
class MobilePlatformApplication202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications.json")
  ...
  def test_2()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications.json")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications/1066175998.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications/1066175998.json")
  ...
  def test_6()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications/1066176000.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications/1066176000.json")
  ...
  def test_7()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications/1066175999.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-01/mobile_platform_applications/1066175999.json")
