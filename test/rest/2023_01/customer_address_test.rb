...
class CustomerAddress202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses.json?limit=1")
      .with(
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses/207119551.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses/207119551.json")
  ...
  def test_4()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses/207119551.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses/207119551.json")
  ...
  def test_7()
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-01/customers/207119551/addresses.json")
