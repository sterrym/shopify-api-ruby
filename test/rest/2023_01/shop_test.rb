...
class Shop202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/shop.json?fields=address1%2Caddress2%2Ccity%2Cprovince%2Ccountry")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/shop.json?fields=address1%2Caddress2%2Ccity%2Cprovince%2Ccountry")
