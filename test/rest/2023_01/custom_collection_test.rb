...
class CustomCollection202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json?ids=395646240%2C691652237%2C841564295")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json?since_id=841564295")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"custom_collections" => [{"id" => 1063001316, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:50-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:03:50-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001316"}]}), headers: {})
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json?since_id=841564295")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json?product_id=632910392")
  ...
  def test_5()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/count.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/count.json")
  ...
  def test_6()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/count.json?product_id=632910392")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/count.json?product_id=632910392")
  ...
  def test_7()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 841564295, "handle" => "ipods", "title" => "IPods", "updated_at" => "2008-02-01T19:00:00-05:00", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "products_count" => 1, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689112056"}}}), headers: {})
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
  ...
  def test_8()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      .with(
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2023-07-11T18:04:00-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689112056"}}}), headers: {})

    response = custom_collection = ShopifyAPI::CustomCollection.new(session: @shopify_api_config.active_session)
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "updated_at" => "2023-07-11T18:04:04-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_10()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => nil, "updated_at" => "2023-07-11T18:03:41-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_11()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "id" => 841564295, "published_at" => "2023-07-11T18:04:12-04:00", "updated_at" => "2023-07-11T18:04:12-04:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_12()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"image" => "", "updated_at" => "2023-07-11T18:03:47-04:00", "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>The best selling ipod ever</p>", "handle" => "ipods", "updated_at" => "2023-07-11T18:03:48-04:00", "id" => 841564295, "sort_order" => "manual", "title" => "IPods", "template_suffix" => nil, "published_at" => "2008-02-01T19:00:00-05:00", "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295"}}), headers: {})
  ...
  def test_13()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2023-07-11T18:04:07-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T18:04:07-04:00", "alt" => "Rails logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/fd43f2c8883f6e9b680e3295fd990d2c.gif?v=1689113047"}}}), headers: {})
  ...
  def test_14()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"updated_at" => "2023-07-11T18:03:45-04:00", "id" => 841564295, "title" => "IPods", "handle" => "ipods", "body_html" => "<p>The best selling ipod ever</p>", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"alt" => "Rails logo", "created_at" => "2023-07-11T18:03:44-04:00", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20230711-85514-r3d2pv.gif?v=1689113025"}}}), headers: {})
  ...
  def test_15()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"body_html" => "<p>5000 songs in your pocket</p>", "title" => "IPods", "handle" => "ipods", "id" => 841564295, "updated_at" => "2023-07-11T18:04:40-04:00", "published_at" => "2008-02-01T19:00:00-05:00", "sort_order" => "manual", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/841564295", "image" => {"created_at" => "2023-07-11T17:47:36-04:00", "alt" => "MP3 Player 8gb", "width" => 123, "height" => 456, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/ipod_nano_8gb.jpg?v=1689112056"}}}), headers: {})
  ...
  def test_16()
    stub_request(:delete, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:delete, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections/841564295.json")
  ...
  def test_17()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: { "custom_collection" => hash_including({"title" => "IPods", "collects" => [{"product_id" => 921728736}]}) }
      )
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001326, "handle" => "ipods-1", "title" => "IPods", "updated_at" => "2023-07-11T18:04:39-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:04:39-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001326"}}), headers: {})
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
  ...
  def test_18()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001322, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:04:28-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:04:28-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001322"}}), headers: {})
  ...
  def test_19()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001314, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:40-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:03:40-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001314"}}), headers: {})
  ...
  def test_20()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001311, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:30-04:00", "body_html" => nil, "published_at" => "2023-07-11T18:03:29-04:00", "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001311", "image" => {"created_at" => "2023-07-11T18:03:30-04:00", "alt" => "Rails Logo", "width" => 110, "height" => 140, "src" => "https://cdn.shopify.com/s/files/1/0005/4838/0009/collections/rails_logo20230711-85514-wsnj5w.gif?v=1689113010"}}}), headers: {})
  ...
  def test_21()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/custom_collections.json")
      ...
      .to_return(status: 200, body: JSON.generate({"custom_collection" => {"id" => 1063001317, "handle" => "macbooks", "title" => "Macbooks", "updated_at" => "2023-07-11T18:03:54-04:00", "body_html" => nil, "published_at" => nil, "sort_order" => "best-selling", "template_suffix" => nil, "published_scope" => "web", "admin_graphql_api_id" => "gid://shopify/Collection/1063001317"}}), headers: {})
