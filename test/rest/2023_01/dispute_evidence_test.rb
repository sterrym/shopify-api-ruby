...
class DisputeEvidence202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/shopify_payments/disputes/598735659/dispute_evidences.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/shopify_payments/disputes/598735659/dispute_evidences.json")
  ...
  def test_2()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2023-01/shopify_payments/disputes/598735659/dispute_evidences.json")
      .with(
    ...
    assert_requested(:put, "https://test-shop.myshopify.io/admin/api/2023-01/shopify_payments/disputes/598735659/dispute_evidences.json")
