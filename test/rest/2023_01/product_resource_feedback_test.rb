...
class ProductResourceFeedback202301Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2023-01/products/632910392/resource_feedback.json")
      .with(
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2023-01/products/632910392/resource_feedback.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2023-01/products/632910392/resource_feedback.json")
      .with(
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2023-01/products/632910392/resource_feedback.json")
