...
class AbandonedCheckout202204Test < Test::Unit::TestCase
  def setup
    super
  ...
  def test_1()
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json?created_at_max=2013-10-12T07%3A05%3A27-02%3A00")
  ...
  def test_2()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json")
  ...
  def test_3()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json?status=closed")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json?status=closed")
  ...
  def test_4()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json?limit=1")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2022-04/checkouts.json?limit=1")
