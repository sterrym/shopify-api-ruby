  ...
  def test_9()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/comments/118373535.json")
      .with(
        ...
        body: { "comment" => hash_including({"body" => "You can even update through a web service.", "author" => "Your new name", "email" => "your@updated-email.com", "published_at" => "2023-06-14T18:19:29.872Z"}) }
      )
