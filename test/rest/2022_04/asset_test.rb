...
class Asset202204Test < Test::Unit::TestCase
  ...
  def test_2()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/themes/828155753/assets.json")
      ...
      .to_return(status: 200, body: JSON.generate({"asset" => {"key" => "templates/index.liquid", "public_url" => nil, "created_at" => "2010-07-12T15:31:50-04:00", "updated_at" => "2023-06-14T14:53:05-04:00", "content_type" => "application/x-liquid", "size" => 110, "checksum" => "cd71db2e14df976c8aa44b44c8dae77b", "theme_id" => 828155753}}), headers: {})
  ...
  def test_5()
    stub_request(:put, "https://test-shop.myshopify.io/admin/api/2022-04/themes/828155753/assets.json")
      ...
      .to_return(status: 200, body: JSON.generate({"asset" => {"key" => "layout/alternate.liquid", "public_url" => nil, "created_at" => "2023-06-14T14:53:09-04:00", "updated_at" => "2023-06-14T14:53:09-04:00", "content_type" => "application/x-liquid", "size" => 3049, "checksum" => "1879a06996941b2ff1ff485a1fe60a97", "theme_id" => 828155753}}), headers: {})
